      ...
      <div className="glass-card p-8 sm:p-10 rounded-3xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {fields.slice(1).map(f => (
            <div key={f.id}>
              <label htmlFor={f.id} className="block text-sm font-semibold text-slate-700 mb-2">
                {f.label}
              </label>
              <input
                id={f.id}
          ...
          <div className="md:col-span-1">
            <label htmlFor="template" className="block text-sm font-semibold text-slate-700 mb-2">
              Paper Template
            </label>
            <select
              id="template"
          ...
          <div className="md:col-span-1">
            <label htmlFor="optionsLayout" className="block text-sm font-semibold text-slate-700 mb-2">
              Options Layout
            </label>
            <select
              id="optionsLayout"
